...
export default function PostCard({ post }) {
  return (
    <div className={`group relative w-full border border-blue-300 hover:border-2 h-[400px] overflow-hidden rounded-lg sm:w-[430px] transition-all bg-gradient-to-b from-white via-white to-slate-200 `}>
